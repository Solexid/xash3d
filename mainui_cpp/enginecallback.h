...
public:
	...
	static inline int	IsMapValid( char *filename )
	{ return engfuncs.pfnIsMapValid( filename ); }
	static inline void	ProcessImage( int texnum, float gamma, int topColor, int bottomColor )
